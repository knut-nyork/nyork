  ...
  const __body0 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: 20,
          flexShrink: 0,
        }}>{props.iconLeft ?? <IconSlotPlaceholder />}</div>
      )}
      {props.text2 && (
      <span style={{
        position: "relative",
      ...
      <div style={{
          ...
          height: 20,
          flexShrink: 0,
        }}>{props.iconRight ?? <IconSlotPlaceholder />}</div>
      )}
    </div>
  );
  const __body1 = () => (
...
export default DataDisplayButton;
