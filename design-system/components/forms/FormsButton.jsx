  ...
  const __body0 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: 20,
          flexShrink: 0,
        }}>{props.iconLeft ?? <FormsIconSlotPlaceholder />}</div>
      )}
      {props.text2 && (
      <span style={{
        position: "relative",
      ...
      <div style={{
          ...
          height: 20,
          flexShrink: 0,
        }}>{props.iconRight ?? <FormsIconSlotPlaceholder />}</div>
      )}
    </div>
  );
  const __body1 = () => (
