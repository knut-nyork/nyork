import { FormsAbstractCheck } from './FormsAbstractCheck.jsx';
import { FormsAbstractMinus } from './FormsAbstractMinus.jsx';
...
export function FormsHeckbox(_p = {}) {
  ...
  const __body7 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: "auto",
          color: "var(--tokens-primary-foreground)",
        }}>{props.icon1 ?? <FormsAbstractMinus />}</div>
    </div>
  );
  const __body8 = () => (
    <div className={props.className} style={{
  ...
  const __body19 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: "auto",
          color: "var(--tokens-primary-foreground)",
        }}>{props.icon1 ?? <FormsAbstractCheck />}</div>
    </div>
  );
  const __body20 = () => (
    <div className={props.className} style={{
    ...
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        <div style={{
            ...
            alignSelf: "stretch",
            height: "auto",
          }}>{props.icon1 ?? <FormsHeckbox style2={"new york"} type={"checkbox only"} disabled={true} state={"filled"} />}</div>
      </div>
      <div style={{
        position: "relative",
        width: 37,
